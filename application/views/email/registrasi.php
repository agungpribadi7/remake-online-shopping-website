<html style="margin:0;padding:0">
    <body style='margin:0; padding:0; font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif;'>
        ...
        <div style="padding: 24px;">
            ...
            Terima kasih telah registrasi pada situs kami. Untuk mengverifikasi akun anda, mohon untuk mengunjungi link berikut : <br />
            <a href="<?php echo $tokenLink; ?>">Link verifikasi</a><br />
